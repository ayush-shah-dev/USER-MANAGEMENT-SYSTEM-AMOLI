...
class UserCreateForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('employee_id','first_name', 'last_name', 'username', 'email', 'password', 'city', 'user_type')
        widgets = {
...
class UserUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('employee_id','first_name', 'last_name', 'username', 'email', 'city', 'user_type')
        widgets = {
            'employee_id': forms.TextInput(attrs={'class': 'form-control'}),
            'first_name': forms.TextInput(attrs={'class': 'form-control'}),
            'last_name': forms.TextInput(attrs={'class': 'form-control'}),
...
class CustomerUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('employee_id','first_name', 'last_name', 'username', 'email', 'city',)
        widgets = {
            'employee_id': forms.TextInput(attrs={'class': 'form-control'}),
            'first_name': forms.TextInput(attrs={'class': 'form-control'}),
            'last_name': forms.TextInput(attrs={'class': 'form-control'}),
